...
public class VistaModCategoria extends JPanel implements ActionListener, MouseListener {
	...
	public VistaModCategoria(InterfazEmpresa interfaz) {

		this.interfaz = interfaz;
		
		TitledBorder border = new TitledBorder("Modificar categoría");
		setBorder(border);
	...
	public void paint(Graphics g) {
		...
		g2d.drawString("Ingresa los datos nuevos de la categoría.", 240,150);
		g2d.setFont(sp);
